...
class DataList
{
    ...
    /**
     * Paginate
     * getPageSize() indicates how many elements there are in a page
     * getTotalCount() indicates how many element there are from getQuery()
     * getPage() shows the current page number
     * getPageCount() represents the total page number 
     * @return self
     */
